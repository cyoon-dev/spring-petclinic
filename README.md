# Spring PetClinic CI/CD Pipeline (GitHub Actions, JFrog Artifactory + Xray) [![Build Status](https://github.com/spring-projects/spring-petclinic/actions/workflows/maven-build.yml/badge.svg)](https://github.com/cyoon-dev/spring-petclinic/actions/workflows/jfrog-ci-maven.yml/badge.svg))
